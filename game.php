...
<button class="btn btn-primary" type="submit" name="submit">Add</button>
    ...
    <?php
        ...
        move_uploaded_file($filename,  $destFile);
            ...
            $sql = "INSERT INTO game(brand,name,des,stock,price,img_name)
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Xbox</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <thead>
    <tr>
     ...
     <?php
      include_once("connection.php");
      $count = 0;
      $rom="SELECT * FROM game WHERE brand='Xbox'";
    ...
    <tr>
      ...
      <td><a href="editgame.php?view=1&id=<?php echo $res['id']; ?>">Edit</a> <a style="color: red;" href="deletegame.php?delete=1&id=<?php echo $res['id']; ?>">Delete</a></td>
    </tr>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">PS4</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
