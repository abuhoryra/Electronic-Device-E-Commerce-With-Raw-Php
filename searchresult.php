...
<div class="container mt-3">
    ...
    <?php
        ...
        if(isset($_GET['search'])){
            ...
            $sql = "Select * from laptop where name = '{$_GET['name']}'
                   union
                   Select * from phone where name = '{$_GET['name']}'
                   union
                   Select * from tab where name = '{$_GET['name']}'
                   union
                   Select * from tv where name = '{$_GET['name']}'
                   union
                   Select * from game where name = '{$_GET['name']}'";
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       include_once("connection.php");
       $name = $res['name'];
      $rkm="Select * from laptop where name = '$name'
                   union
